...
{
    private static final HttpCompliance RFC2616 = HttpCompliance.rfc2616Builder().build();
    private static final HttpCompliance RFC7230 = HttpCompliance.rfc7230Builder().build();
    ...
    {
        connector.getConnectionFactory(HttpConnectionFactory.class).getHttpConfiguration().setHttpCompliance(RFC2616);
        String request = "GET / HTTP/0.9\r\n\r\n";
        String response = connector.getResponse(request);
        assertThat(response, containsString("400 Bad Version"));

        connector.getConnectionFactory(HttpConnectionFactory.class).getHttpConfiguration().setHttpCompliance(RFC7230);
